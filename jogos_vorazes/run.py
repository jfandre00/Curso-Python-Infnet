...
import jogadores.kamikaze as kamikase
...
def jogo():
    ...
    jogadores.append(criar_jogador("Carla", carol.estrategia_carol))
    ...
    jogadores.append(criar_jogador("Kamikase", kamikase.estrategia_kamikase))
...
# 3. Estratégia de ataque arriscado, ou seja, há uma chance do ataque falhar ou então atacar todos os outros jogadores (Pr=0.8 de falhar)
# 4. Função de cura, que aumenta a vida do jogador (mas não acima de 100)
# ...Que mais???